/**
 * ContainerAdapter - Interface for container/isolation backends
 *
 * Platform-agnostic interface. Implementations use SystemAdapter
 * for all OS-specific operations.
 */
...
/**
 * Shell command for terminal attachment
 */
...
export interface ContainerAdapter {
   ...
   */
  getShellCommand?(containerId: string, worktreePath: string): ShellCommand | null;
